...
(0, _jquery.default)('.song-item').hover(function () {
  (0, _jquery.default)(this).find('.list-menu').stop().fadeIn();
  (0, _jquery.default)(this).find('.list-time').children('a').stop().fadeIn();
}, function () {
  (0, _jquery.default)(this).find('.list-menu').stop().fadeOut();
  (0, _jquery.default)(this).find('.list-time').children('a').stop().fadeOut();
});
(0, _jquery.default)('.list-check').on('click', function () {
  (0, _jquery.default)(this).find('i').toggleClass('active');
});
},{"./jquery.min":"../js/jquery.min.js"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
